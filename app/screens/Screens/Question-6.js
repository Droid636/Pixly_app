...
const Question_6 = ({navigation, route}) => {
  ...
  return (
    <View style={Styles.Body}>
      <View style={Styles.Container}>
        ...
        <Text style={Styles.Cuestion} >¿Qué etiqueta crea una celda en una tabla?</Text>
      ...
      <View style={Styles.Button_Items}>
        <TouchableOpacity style={Styles.Button} onPress={() => navigation.navigate('Question-5')}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            setAnswer(null);
            setMessage('');
            navigation.navigate('Question-7', {life: valor, score: getNextScore() });
          }}
