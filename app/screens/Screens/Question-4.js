...
const Question_4 = ({navigation, route}) => {
  ...
  return (
    <View style={Styles.Body}>
      <View style={Styles.Container}>
        ...
        <Text style={Styles.Cuestion} >¿Cuál de estas etiquetas se usa para crear una lista ordenada?</Text>
      ...
      <View style={Styles.Button_Items}>
        <TouchableOpacity style={Styles.Button} onPress={() => navigation.navigate('Question-3')}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            setAnswer(null);
            setMessage('');
            navigation.navigate('Question-5', {life: valor, score: getNextScore() });
          }}
