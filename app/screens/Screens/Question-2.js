...
const Question_2 = ({navigation, route}) => {
  ...
  return (
    <View style={Styles.Body}>
      <View style={Styles.Container}>
        ...
        <Text style={Styles.Cuestion} >¿Qué etiqueta se utiliza en HTML para crear un enlace a otra página web?</Text>
      ...
      <View style={Styles.Button_Items}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            setAnswer(null);
            setMessage('');
            navigation.navigate('Question-3', {life: valor, score: getNextScore() });
          }}
