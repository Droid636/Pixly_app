...
type Question9ScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'Question-9'
>;

type Question9ScreenRouteProp = RouteProp<RootStackParamList, 'Question-9'>;

type Props = {
  navigation: Question9ScreenNavigationProp;
  route: Question9ScreenRouteProp;
};
...
const Question_9: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={Styles.Body}>
      ...
      <View style={Styles.Button_Items}>
        <TouchableOpacity
          style={Styles.Button}
          onPress={() => navigation.navigate('Question-8', { life: valor, score })}
        >
