...
type RootStackParamList = {
  'Question-10': { life?: number; score?: number };
  'Rsultado': { life: number; score: number };
};

type Question10ScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'Question-10'
>;

type Question10ScreenRouteProp = RouteProp<RootStackParamList, 'Question-10'>;

type Props = {
  navigation: Question10ScreenNavigationProp;
  route: Question10ScreenRouteProp;
};
...
const Question_10: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={Styles.Body}>
      ...
      <View style={Styles.Button_Items}>
        <TouchableOpacity
          style={Styles.Button}
          onPress={() => navigation.navigate('Rsultado', { life: valor, score: getNextScore() })}
          disabled={answer === null}
        >
