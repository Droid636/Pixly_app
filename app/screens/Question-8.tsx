...
type RootStackParamList = {
  ...
  'Question-9': { life: number; score: number };
};

type Question8ScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'Question-8'
>;

type Question8ScreenRouteProp = RouteProp<RootStackParamList, 'Question-8'>;

type Props = {
  navigation: Question8ScreenNavigationProp;
  route: Question8ScreenRouteProp;
};
...
const Question_8: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={Styles.Body}>
      <View style={Styles.Container}>
        ...
        <Text style={Styles.Cuestion}>¿Qué elemento se usa para definir un encabezado de nivel 1?</Text>
      ...
      <View style={Styles.Button_Items}>
        <TouchableOpacity
          style={Styles.Button}
          onPress={() => navigation.navigate('Question-7', { life: valor, score })}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            setAnswer(null);
            setMessage('');
            navigation.navigate('Question-9', { life: valor, score: getNextScore() });
          }}
          disabled={answer === null}
        >
